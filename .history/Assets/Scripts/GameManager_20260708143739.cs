...
public class GameManager : MonoBehaviour
{
    ...
    public void GameOver()
    {
        ...
        // Dừng toàn bộ gameplay trước khi quảng cáo xuất hiện.
        Time.timeScale = 0f;

        // Hiển thị quảng cáo toàn màn hình khi Game Over.
        if (AdsManager.Instance != null)
        {
            // Không hiện Banner tại màn hình Game Over.
            AdsManager.Instance.HideBanner();

            // Hiện quảng cáo toàn màn hình.
            AdsManager.Instance.ShowGameOverAd();
        }
        else
        {
            Debug.LogWarning("Không tìm thấy AdsManager trong Scene.");
        }
    }
